...
import { Upload, Building2, User, ToggleLeft, ToggleRight } from "lucide-react";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isAdminMode) {
        ...
        const response = await apiRequest(API_ENDPOINTS.ADMIN_CREATE, {
          method: "POST",
          body: JSON.stringify({
        ...
        alert("✅ Admin account created successfully! Credentials sent via email.");
        setAdminFormData({
          name: "",
          email: "",
          role: "",
        ...
        // Bank agent account creation (existing logic)
      ...
      alert(isAdminMode ? "Error creating admin account" : "Error creating bank account");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold text-white flex items-center gap-3">
            {isAdminMode ? "Create Admin Account" : "Create Bank Account"}
          </h1>
      ...
      <form onSubmit={handleSubmit} className="p-8">
        ...
        <div className="flex justify-end gap-4">
          ...
          >
            {loading ? "Submitting..." : isAdminMode ? "Create Admin" : "Create Bank Account"}
          </button>
        </div>
      </form>
    </div>
