...
const EducationTable: React.FC = () => {
  ...
  const fetchLoans = async () => {
    ...
    try {
      ...
      let filtered: LoanApplication[] = data.data.map((loan: any) => ({
        ...
        created_at: loan.createdat || loan.date || "",
      }));
  ...
  try {
    const res = await fetch(
      `${API_BASE_URL}/api/loans/education_loans/${loanId}/status`,
      {
        method: "PATCH",
        ...
        <table className="w-full border-collapse">
          <thead className="bg-gray-100 dark:bg-gray-800">
            <tr>
              ...
              <th className="text-left p-3 border-b border-gray-200 dark:border-gray-700">Amount Required</th>
  ...
  <Info
    ...
    onClick={() =>
      navigate("/EducationLoanDetails", {
        state: { id: loan.id, table: "education_loans" }, 
      })
    }
  />
</td>
