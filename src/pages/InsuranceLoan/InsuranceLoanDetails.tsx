...
const InsuranceLoanDetails: React.FC = () => {
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-800 via-blue-600 to-sky-400 text-white p-6 rounded-2xl shadow-lg">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
          <div>
            <h2 className="text-xl font-semibold">{loanDetails.full_name || loanDetails.fullname}</h2>
            <p className="text-sm opacity-90">{loanDetails.contact_number || loanDetails.mobile || loanDetails.phone}</p>
          </div>
...
export default InsuranceLoanDetails;
