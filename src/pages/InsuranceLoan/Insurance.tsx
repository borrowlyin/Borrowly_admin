        ...
        <table className="w-full border-collapse">
          <thead className="bg-gray-100 dark:bg-gray-800">
            <tr>
              ...
              <th className="text-left p-3 border-b border-gray-200 dark:border-gray-700">Anual Income</th>
            ...
            {loading ? (
              ...
              loans.map((loan) => (
                <tr key={loan.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="p-3 border-b border-gray-200 dark:border-gray-700"
                   onClick={() => navigate("/InsuranceLoanDetails", { state: { id: loan.id, table: "insurance_loans" } })}>
