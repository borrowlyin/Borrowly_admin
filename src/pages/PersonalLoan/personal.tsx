...
const PersonalTable: React.FC = () => {
  ...
  const handlepersonalloan = (id: string, table: string) => {
    navigate("/PersonalLoanDetails", {
      state: { id, table },
    });
  };
              ...
              loans.map((loan) => (
                <tr key={loan.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td
                    ...
                    onClick={() => handlepersonalloan(loan.id, table)}
                  >
                    <Info className="h-5 w-5 inline text-blue-500 hover:scale-110 transition-transform" />
                  </td>
