  ...
  return r(void 0, void 0, void 0, function() {
    ...
    return c(this, function(c2) {
      switch (c2.label) {
        ...
        case 1:
          for (t2 = c2.sent(), a2 = [], o2 = 0, i2 = t2; o2 < i2.length; o2++) for (r2 = i2[o2], s2 = 0, u2 = r2.states; s2 < u2.length; s2++) for (l2 = u2[s2], d2 = 0, f2 = l2.cities; d2 < f2.length; d2++) m2 = f2[d2], a2.push(m2);
          return [2, a2];
      }
    });
  });
...
var C = function(r2) {
  ...
  (0, import_react.useEffect)(function() {
    if (f2) if ("string" == typeof f2) (e2 = s2.find(function(e3) {
      return e3.name === f2;
    })) && j2(e2);
